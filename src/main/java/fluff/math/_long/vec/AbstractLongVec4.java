...
public abstract class AbstractLongVec4<V extends AbstractLongVec4<V>> implements ILongVec<V> {
	...
	protected abstract long getW();
	
	protected abstract void set(long x, long y, long z, long w);
	...
	public boolean equals(Object obj) {
		if (obj instanceof AbstractLongVec4 vec) {
